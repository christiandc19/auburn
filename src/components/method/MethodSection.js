  ...
  return (
    <>
      ...
      <div className="container treatment-section-overview">
        ...
        <p>
          Here at Auburn Rehab, we firmly stand that without addressing our
          ...
          <br />
          <br />
          Methods used by Auburn Rehab are non-invasive, distinct, and
      ...
      <div className="treatment-section-activities">
        <div className="treatment-left">
          ...
          <p>
            Auburn Rehab promotes fun activities that clients learn how to
